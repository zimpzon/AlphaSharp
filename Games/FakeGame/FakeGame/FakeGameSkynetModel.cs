...
namespace FakeGame
{
    public class FakeGameSkynetModel : torch.nn.Module<torch.Tensor, (torch.Tensor, torch.Tensor)>
    {
        ...
        public FakeGameSkynetModel(int inputSize, int outputSize) : base("tixy")
        {
