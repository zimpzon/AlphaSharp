...
namespace TixyGame
{
    public class GenericSkynetModelConv : torch.nn.Module<torch.Tensor, (torch.Tensor, torch.Tensor)>
    {
        ...
        public GenericSkynetModelConv(IGame game, int numInputChannels, bool forceCpu = false) : base("generic")
        {
            _game = game;
